...
public class CTeInfCteInfCTeNormInfDocInfNFeInfUnidTranspInfUnidCarga {
	...
	public List<CTeInfCteInfCTeNormInfDocInfNFeInfUnidTranspInfUnidCargaLacUnidCarga> getLacUnidCarga() {
		return lacUnidCarga;
	}

	public void setLacUnidCarga(List<CTeInfCteInfCTeNormInfDocInfNFeInfUnidTranspInfUnidCargaLacUnidCarga> lacUnidCarga) {
