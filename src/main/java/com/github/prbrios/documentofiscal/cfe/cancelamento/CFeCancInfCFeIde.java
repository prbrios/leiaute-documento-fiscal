...
public class CFeCancInfCFeIde {
     ...
     * @param numeroCaixa
     */
    public CFeCancInfCFeIde(String cUF, String cNF, String mod, String nserieSAT, String nCFe, String dEmi, String hEmi, String cDV, String cnpj, String signAC, String assinaturaQRCODE, String numeroCaixa) {
        this.cUF = cUF;
        this.cNF = cNF;
        this.mod = mod;
